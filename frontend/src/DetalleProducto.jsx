...
export default function DetalleProducto({
  ...
  const tabs = [
    ...
    [
      "opiniones",
      `Opiniones (${productoActual.opiniones?.length || 0})`,
    ],
  ];
      ...
      <main className="pt-[88px]">
        ...
        <div className="max-w-[1200px] mx-auto px-5 md:px-10 py-4">
          <div className="flex items-center gap-2 text-[9px] text-gray-400">
            ...
            <button
              onClick={() =>
                onCatalogo(productoActual.categoria)
              }
              className="hover:text-orange-500"
            >
          ...
          <div className="grid grid-cols-1 lg:grid-cols-[1fr_1.15fr_0.7fr] gap-7">
            ...
            <div>
              ...
              <div className="relative h-[360px] bg-gray-50 rounded-xl overflow-hidden border border-gray-100">
                ...
                <button
                  onClick={() =>
                    onAlternarFavorito(productoActual)
                  }
                  className={`absolute top-4 right-4 w-10 h-10 bg-white rounded-full shadow-md text-xl ${
                    favorito
                      ? "text-orange-500"
                      : "text-gray-500"
                  }`}
              ...
              <div className="flex items-center gap-3 mt-3">
                ...
                {imagenes.map((imagen, index) => (
                  <button
                    ...
                    className={`w-[70px] h-[58px] rounded-md overflow-hidden border-2 ${
                      imagenActiva === index
                        ? "border-orange-500"
                        : "border-gray-200"
                    }`}
            ...
            <div>
              ...
              <div className="flex gap-3 mt-5">
                ...
                <button
                  onClick={agregar}
                  className="flex-1 bg-orange-500 hover:bg-orange-600 text-white rounded-md text-[10px] font-black transition"
                >
                  🛒 AGREGAR AL CARRITO
                </button>
              ...
              <button
                ...
                className={`w-full mt-2 h-10 border rounded-md text-[10px] font-bold ${
                  favorito
            ...
            <div className="flex gap-7 border-b border-gray-200 overflow-x-auto">
              ...
              {tabs.map(([id, label]) => (
                <button
                  ...
                  className={`py-4 text-[10px] font-bold whitespace-nowrap border-b-2 ${
                    pestana === id
